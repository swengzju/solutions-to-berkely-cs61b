  ...
  public Maze(int horizontalSize, int verticalSize) {
    ...
    if((horiz > 1) && (vert > 1)){
        ...
        for(int[] cur: allWalls){
            ...
            //determine which cells are next to the wall
            if(isHWall) {
            ...
            //find the root of the two adjacent cells
            ...
            //if they are different sets, union them and eliminate the wall separating them.
